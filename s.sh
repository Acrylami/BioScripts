...
#  snippy --cpus ${SLURM_CPUS_PER_TASK} --ref "${reference}" --outdir "${output}/snip_${base}" --R1 "${file1}" --R2 "${file2}" --force
#done
# snippy --cpus ${SLURM_CPUS_PER_TASK} --ref "${reference}" --outdir "${output}" --R1 "${file1}" --R2 "${file2}" --force
#snippy-core --ref "${reference}" --prefix "${output}/output-alignment" "${output}/snip*"
snippy-core --ref "${reference}" --prefix "${output}/output-alignment" snip_*
